...
export const skillsSection: SkillsSectionType = {
  title: 'Skills',
  subTitle:
    'I AM A PASSIONATE FULL-STACK DEVELOPER WITH EXPERTISE IN AI INTEGRATION AND CLOUD SOLUTIONS',
  data: [
    {
      ...
      skills: [
        emoji(
          '⚡ Building responsive Single-Page-Apps (SPA) & PWA in React.js and Next.js 13+'
        ),
        emoji('⚡ Building RESTful APIs in Node.js, Express.js, and FastAPI'),
        emoji(
          '⚡ Experience of working on cloud platforms such as Vercel, Railway, and Docker'
        ),
        emoji(
          '⚡ Hosting and maintaining websites with PostgreSQL and MongoDB databases'
        ),
        emoji(
          '⚡ Experience of building AI-powered applications with LangChain and OpenAI APIs'
        ),
      ],
      softwareSkills: [
        {
    ...
    },
    {
      ...
      skills: [
        emoji(
          '⚡ Proficient in Java, JavaScript, C++, TypeScript, Python, and SQL'
        ),
        emoji(
          '⚡ Strong foundation in Data Structures and Algorithms (500+ LeetCode problems solved)'
        ),
        emoji(
          '⚡ Experience with AI/ML tools including LangChain, OpenAI APIs, Scikit-learn, and Pandas'
        ),
      ],
      softwareSkills: [
        {
...
export const educationInfo: EducationType[] = [
  {
    ...
    grade: 'CGPA: 9.22',
    descBullets: [
      'Technical Head at Data Science Community (DASCA)',
      'Leading cross-functional teams and organizing technical events',
...
export const experience: ExperienceType[] = [
  {
    role: 'Technical Head',
    company: 'Data Science Community (DASCA)',
    date: 'Sep 2024 – Present',
    desc: 'Leading a 10+ member core team to organize 5+ technical workshops, coding competitions, and AI/ML seminars impacting 200+ students. Mentoring junior members in data science, web development, and coding best practices, improving project completion rates by 30%. Coordinating with industry experts to deliver guest lectures on AI, data analytics, and emerging technologies.',
    companyLogo: '/img/icons/common/dasca.jpg',
  },
  {
...
export const Volunteerexperience: VolunteerExperienceType[] = [
  {
    ...
    companylogo: '/img/icons/common/dasca.jpg',
    date: 'Sep 2024 – Present',
    desc: 'Leading cross-functional teams and organizing technical events. Mentoring junior members in data science, web development, and coding best practices. Coordinating with industry experts for guest lectures on AI, data analytics, and emerging technologies.',
  },
];
...
export const feedbacks: FeedbackType[] = [
  {
    ...
    feedback:
      'Solved 500+ LeetCode problems with a rating of 1676. Earned 100 Days Badge for consistency and strong problem-solving skills.',
  },
  {
    name: 'CodeChef Competitive Programmer',
    feedback:
      'Attained 2-star CodeChef rating (1478) with 300+ competitive programming problems solved.',
  },
  {
    name: 'Production Deployment Expert',
    feedback:
      'Successfully deployed 3+ production-ready full-stack applications with zero downtime and 99.9% uptime.',
  },
  {
    name: 'Zscaler Zero Trust Associate (ZTCA)',
    feedback:
      'Certified in Cybersecurity and zero trust architecture, demonstrating expertise in modern security practices.',
  },
  {
    name: 'NVIDIA Deep Learning Fundamentals',
    feedback:
      'Completed NVIDIA DLI training in neural networks and GPU computing, showcasing AI/ML expertise.',
  },
];
