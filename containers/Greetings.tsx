      ...
      <div className="position-relative">
        ...
        >
          ...
          <div className="shape shape-style-1 bg-gradient-info">
            ...
            <span
              style={{ animation: 'float 7.5s ease-in-out infinite reverse' }}
            />
              ...
              <Row className="align-items-center">
                    ...
                    {greetings.resumeLink && (
                      <div className="btn-wrapper my-4 d-flex flex-wrap gap-3">
                        ...
                        >
                          ...
                          <span className="btn-inner--text">View GitHub</span>
                        </Button>
                      </div>
                    )}
                  </div>
                ...
                <Col lg="6" className="order-1 order-lg-2">
                  <div
                    ...
                    style={{ animation: 'slideInRight 1s ease-out 0.3s both' }}
                  >
